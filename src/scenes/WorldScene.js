...
export class WorldScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.feedingStations = new FeedingStationSystem(this, this.mapManager).create();
    this.animalManager = new AnimalManager(this, this.mapManager, this.feedingStations).create();
    this.careActions = new CareActionSystem(this, this.player, this.feedingStations);
    this.animalInteraction = new AnimalInteractionSystem(this, this.player, this.animalManager, this.feedingStations, this.careActions);
    ...
    this.debugOverlay = new DebugOverlay(this, this.mapManager, this.transitionManager, this.player, this.animalManager, this.feedingStations);
    ...
    this.events.once(Phaser.Scenes.Events.SHUTDOWN, () => this.registry.set('gameTimeMinutes', this.gameTime.totalMinutes));
